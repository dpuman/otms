                ...
                <div class="card-body">
                    ...
                    <form action="{{route('course.update',['id'=>$course->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input value="{{$course->title}}" type="text" name="title" class="form-control" id="horizontal-firstname-input">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea   name="objective" class="form-control" id="horizontal-obj-input">{{$course->objective}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea  name="description" class="summernote" id="horizontal-des-input">{{$course->description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="date" value="{{$course->starting_date}}" name="starting_date"  class="form-control" id="horizontal-date-input">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input value="{{$course->fee}}" type="number" name="fee"  class="form-control" id="horizontal-fee-input">
                            </div>
                        </div>
